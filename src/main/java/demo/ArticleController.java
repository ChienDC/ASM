...
public class ArticleController {
    ...
    public void creatAndSave() {
        ...
        newArticle.setCreatedAt(String.valueOf(LocalDate.parse(scanner.nextLine())));

        System.out.print("Enter update date (yyyy-MM-DD): ");
        newArticle.setUpdateAt(String.valueOf(LocalDate.parse(scanner.nextLine())));

        System.out.print("Enter delete date (yyyy-MM-DD): ");
        newArticle.setDeleteAt(String.valueOf(LocalDate.parse(scanner.nextLine())));
